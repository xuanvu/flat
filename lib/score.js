...
Score.prototype.commitScore = function (message, authorName, authorEmail, head, callback) {
  ...
  async.waterfall([
    ...
    function (_index, callback) {
      ...
      this.repo.commits(head, 1, callback);
    }.bind(this),
    function (commits, callback) {
      ...
      index.read_tree(commits[0].tree.id, callback);
    },
