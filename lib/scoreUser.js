...
exports.getRights = function (scoreId, userId, callback) {
  ...
  async.waterfall([
    ...
    function (scoredb, callback) {
      if (!scoredb) {
        return callback(true, 404);
      }

      if (scoredb.userId == userId) { // js type if different un sql
      ...
      if (userId) {
        schema.models.ScoreCollaborator.findOne({
          where: { scoreId: scoreId.id || scoreId, userId: userId }
...
exports.removeCollaborator = function (scoreId, userId, collaborator, callback) {
  async.waterfall([
    ...
    function (collab, callback) {
      if (!collab) {
        return callback("The collaborator doesn't exist", 404);
      }
